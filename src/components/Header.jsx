                ...
                session ? (
                    <div className='flex gap-2 items-center'>
                        <IoMdAddCircleOutline 
                            className='text-2xl cursor-pointer transfrom hover:scale-125 transition duration-300 hover:text-red-600'
                    ...
                    <button className='text-sm font-semibold text-blue-500' onClick={() => signIn()}>
                        Log In
                    </button>
                )
            }
